...
test('runner rejects unsupported commands until their authoritative runtime exists', () => {
  const runner = createRunner();
  assert.deepEqual(
    runner.enqueue('blue-1', { type: 'cast', playerId: 'blue-1', seq: 1, tick: 0, slot: 'Q', x: 1000, y: 1500 }),
